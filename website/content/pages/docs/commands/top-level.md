...
- For fresh Java work, follow the boring loop: list templates, initialize from the closest template, search and read docs for unknown APIs, generate the source, format it, check it, write tests, run tests, then report done.
