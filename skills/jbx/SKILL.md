...
Install the latest release from the jbx repository releases, or build from a checkout when working on jbx itself.
...
If `jbx` is already installed globally, verify it before use:
