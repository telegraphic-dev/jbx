...
- `jbx test [script.java|directory]` run JUnit tests with the standalone console launcher; add `--coverage` to collect JaCoCo data in `target/jacoco.exec` (optionally pin the agent with `--jacoco-version`)
